package cn.onoff.electronicjournal.controller.applet;

import cn.onoff.electronicjournal.model.WeChatUser;
import cn.onoff.electronicjournal.service.UserService;
import cn.onoff.electronicjournal.utils.GlobalResult;
...
public class UserController {
    ...
    public GlobalResult user_login(@RequestParam(value = "code", required = false) String code,
        ...
        WeChatUser user = this.service.selectById(openid);
